...
ipcMain.handle('oauth:open',async(_e,provider)=>{if(provider!=='GitHub')return{ok:false,message:'GitHub sign-in is currently supported'};await shell.openExternal(`${AUTH_URL}/auth/github`);return{ok:true,provider,authUrl:AUTH_URL}});
